...
public:
    ...
    bool lastBoardData(quint32 paramId, QVector<DataValue> &values,
    ...
    QMap<QString, QSharedPointer<LiveDataSourceInterface>> liveDataSources()
        const;
    QMap<QString, QSharedPointer<PlaybackDataSourceInterface>>
    playbackDataSources() const;
    QSharedPointer<LiveDataSourceInterface> referenceTimeLiveDataSource() const;
    void setReferenceTimeLiveDataSource(
        const QSharedPointer<LiveDataSourceInterface>
            &referenceTimeLiveDataSource);
