...
public:
    ...
    {
        mValue.ui64 = 0;
        mValue.s_ui8.uint8 = v;
        mType = TYPE_UINT8;
    }
    DataValue(qint16 v)
    {
        mValue.ui64 = 0;
        mValue.s_i16.int16 = v;
        mType = TYPE_INT16;
    }
    DataValue(quint16 v)
    {
        mValue.ui64 = 0;
        mValue.s_ui16.uint16 = v;
        mType = TYPE_UINT16;
    }
    DataValue(qint32 v)
    {
        mValue.ui64 = 0;
        mValue.s_i32.int32 = v;
        mType = TYPE_INT32;
    }
    DataValue(quint32 v)
    {
        mValue.ui64 = 0;
        mValue.s_ui32.uint32 = v;
        mType = TYPE_UINT32;
    }
    DataValue(float v)
    {
    ...
    void int8_value(qint8 v)
    {
        mValue.s_i8.int8 = v;
        mType = ValueType::TYPE_INT8;
    }
    void uint8_value(quint8 v)
    {
        mValue.s_ui8.uint8 = v;
        mType = ValueType::TYPE_UINT8;
    }
    void int16_value(qint16 v)
    {
        mValue.s_i16.int16 = v;
        mType = ValueType::TYPE_INT16;
    }
    void uint16_value(quint16 v)
    {
        mValue.s_ui16.uint16 = v;
        mType = ValueType::TYPE_UINT16;
    }
    void int32_value(qint32 v)
    {
        mValue.s_i32.int32 = v;
        mType = ValueType::TYPE_INT32;
    }
    void uint32_value(quint32 v)
    {
        mValue.s_ui32.uint32 = v;
        mType = ValueType::TYPE_UINT32;
    }
    void int64_value(qint64 v)
    {
        mValue.i64 = v;
        mType = ValueType::TYPE_INT64;
    }
    void uint64_value(quint64 v)
    {
        mValue.ui64 = v;
        mType = ValueType::TYPE_UINT64;
    }
        ...
        switch (mType) {
            case TYPE_FLOAT:
                if (fullDouble)
                    ...
                    return QString::number(double(mValue.s_f.f), 'f',
                                           precision);
            case TYPE_DOUBLE:
                if (fullDouble)
    ...
    QString toHex() const
    {
        switch (mType) {
            ...
            case TYPE_UINT8:
                return QString("0x") +
                       QString("%1")
                           .arg(uint8_value(), 2, 16, QChar('0'))
                           .toUpper();
            case TYPE_INT16:
            case TYPE_UINT16:
                return QString("0x") +
                       QString("%1")
                           .arg(uint16_value(), 4, 16, QChar('0'))
                           .toUpper();
            case TYPE_FLOAT:
            case TYPE_INT32:
            case TYPE_UINT32:
            ...
            case TYPE_UINT64:
                return QString("0x") +
                       QString("%1")
                           .arg(uint64_value(), 16, 16, QChar('0'))
                           .toUpper();
        }
        return QString();
    }
    ...
    QString toBin() const
    {
        switch (mType) {
            ...
            case TYPE_UINT8:
                return QString("0b") +
                       QString("%1").arg(uint8_value(), 8, 2, QChar('0'));
            case TYPE_INT16:
            case TYPE_UINT16:
                return QString("0b") +
                       QString("%1").arg(uint16_value(), 16, 2, QChar('0'));
            case TYPE_FLOAT:
            case TYPE_INT32:
            case TYPE_UINT32:
                return QString("0b") +
                       QString("%1").arg(uint32_value(), 32, 2, QChar('0'));
            case TYPE_DOUBLE:
            case TYPE_INT64:
            case TYPE_UINT64:
                return QString("0b") +
                       QString("%1").arg(uint64_value(), 64, 2, QChar('0'));
        }
        return QString();
    }
    ...
    QString toTime() const
    {
        switch (mType) {
            case TYPE_FLOAT:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.s_f.f)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_DOUBLE:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.d)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_INT8:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.s_i8.int8)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_UINT8:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.s_ui8.uint8)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_INT16:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.s_i16.int16)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_UINT16:
                return QDateTime::fromMSecsSinceEpoch(1000 *
                                                      mValue.s_ui16.uint16)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_INT32:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.s_i32.int32)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_UINT32:
                return QDateTime::fromMSecsSinceEpoch(1000 *
                                                      mValue.s_ui32.uint32)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_INT64:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.i64)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
            case TYPE_UINT64:
                return QDateTime::fromMSecsSinceEpoch(1000 * mValue.ui64)
                    .toUTC()
                    .toString("hh:mm:ss.zzz");
        }
        return QString("--:--:--.---");
