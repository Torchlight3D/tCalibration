...
ColorLineEdit::ColorLineEdit(QWidget *parent)
    : QLineEdit(parent), mColorText(true), mColorSettings(new ColorSettings)
{
...
QColor ColorLineEdit::color() const { return mColorSettings->color(); }
...
bool ColorLineEdit::colorText() const { return mColorText; }

void ColorLineEdit::setColorText(bool colorText) { mColorText = colorText; }
