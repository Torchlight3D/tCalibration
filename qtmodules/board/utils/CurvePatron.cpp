...
Qt::PenStyle CurvePatron::penStyle() const { return mPenStyle; }
...
int CurvePatron::penWidth() const { return mPenWidth; }
...
QString CurvePatron::name() const { return mName; }

void CurvePatron::setName(const QString &name) { mName = name; }

QPen CurvePatron::pen() const { return mPen; }

QList<double> CurvePatron::xValues() const { return mXValues; }

QList<double> CurvePatron::yValues() const { return mYValues; }
