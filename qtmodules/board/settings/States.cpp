...
void States::addState(bool active, qlonglong value, const QString& text,
...
QMap<qlonglong, QString> States::statesText() const { return mStatesText; }

bool States::modified() const { return mModified; }

void States::setModified(bool modified) { mModified = modified; }
