...
void Thresholds::insertLowThreshold(double value,
...
void Thresholds::insertHighThreshold(double value,
                                     const ColorSettings& colorSettings)
{
...
void Thresholds::clearLowThresholds() { mLowThresholds.clear(); }
...
{
    if (mHighThresholds.count() > 0 || mLowThresholds.count() > 0)
        return true;
    return false;
}

Thresholds::CheckOrder Thresholds::checkOrder() const { return mCheckOrder; }

void Thresholds::setCheckOrder(CheckOrder checkOrder)
{
...
bool Thresholds::modified() const { return mModified; }
