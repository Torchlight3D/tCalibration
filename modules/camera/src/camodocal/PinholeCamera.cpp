...
bool PinholeCamera::Parameters::read(const cv::FileNode &node)
{
...
void PinholeCamera::Parameters::write(cv::FileStorage &fs) const
{
    // Meta
...
bool PinholeCamera::withoutDistortion() const
{
