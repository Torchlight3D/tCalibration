    ...
    if (depth == 4) {
        ...
        if (path[4] == path[0]) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                GLine2D linea(
                    std::make_pair(path[i]->getX0(), path[i]->getY0()),
            ...
            if (!bad) {
                float t0 = std::atan2(p[1].second - p[0].second,
                                      p[1].first - p[0].first);
                float t1 = std::atan2(p[2].second - p[1].second,
                                      p[2].first - p[1].first);
                float t2 = std::atan2(p[3].second - p[2].second,
                                      p[3].first - p[2].first);
                float t3 = std::atan2(p[0].second - p[3].second,
                                      p[0].first - p[3].first);
