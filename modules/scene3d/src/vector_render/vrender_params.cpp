                              ...
                              VRenderParams &vparams)
{
    ...
    try {
        ...
        vparams.progress(0.0, "Rendering...");
        ...
        cout << "Size = " << vparams.size() << ", returned=" << returned
             << endl;
#endif
        ...
        switch (vparams.format()) {
            ...
            default:
                throw std::runtime_error(
                    "Sorry, this output format is not handled now. Only EPS "
                    "and PS are currently supported.");
        }
        ...
        lineWidth /= (float)std::max(viewport[2] - viewport[0],
        ...
        for (auto *primitive : primitive_tab) {
            delete primitive;
        }
        ...
        std::cout << "Render aborted: " << e.what() << std::endl;
