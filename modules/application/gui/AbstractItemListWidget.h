...
class AbstractItemListWidget : public QWidget
{
    ...
    Q_PROPERTY(bool itemsShouldExpand READ itemsShouldExpand WRITE
                   setItemsShouldExpand NOTIFY itemsShouldExpandChanged)
...
public:
    ...
    int addItem(const QString& text, const QIcon& icon = {},
...
protected:
    ...
    virtual const QColor& getItemFgColor(MouseState mouse, bool selected,
                                         const Theme& theme) const = 0;
    virtual const QColor& getItemBgColor(MouseState mouse,
                                         const Theme& theme) const = 0;
    virtual const QColor& getItemFgColor(MouseState mouse, bool selected,
    ...
    virtual const QColor& getItemBadgeBgColor(MouseState mouse, bool selected,
                                              const Theme& theme) const = 0;
    virtual const QColor& getItemBadgeFgColor(MouseState mouse, bool selected,
                                              const Theme& theme) const = 0;
    virtual const QColor& getItemBadgeBgColor(MouseState mouse, bool selected,
                                              const QPalette& palette) const;
    virtual const QColor& getItemBadgeFgColor(MouseState mouse, bool selected,
...
protected:
    ...
    bool hitTestItemRect(const QPoint& pos, const QRect& itemRect,
                         int leftPadding, int rightPadding) const;
    void updateItemsSizeHints();
    void updateItemRects();
    MouseState getItemMouseState(int index, const Item& item) const;
    std::tuple<QColor, QColor, QColor, QColor> getItemBgAndFgColor(
