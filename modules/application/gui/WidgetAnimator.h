...
// So we declare all available animations with a macro, to avoid boilerplate
// code. The animations themselves will be ceated lazily, on demand, when needed
// to paint.
...
private:                                                                      \
    ...
    {                                                                         \
        ...
        return *_##NAME;                                                      \
                                                                              ...
                                                                              \
public:                                                                       \
    TYPE get##NAME() const { return get##NAME##Animation().value(); }         \
    ...
    void stop##NAME() { get##NAME##Animation().stop(); }                      \
...
public:
    explicit WidgetAnimator(QWidget* parent)
        : QObject(parent), _parentWidget(parent)
    {
    }
