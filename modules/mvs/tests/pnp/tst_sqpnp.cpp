...
class SQPnPTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
                 ...
                 const Eigen::Vector3d& translation)
    {
        ...
        EXPECT_TRUE(
            SQPnP(imagePoints, objectPoints, rotations_est, translations_est));
...
TEST_F(SQPnPTest, MinimumNoNoise)
{
    // Configs.
    // TODO: Is it possible to achieve higher accuracy???
    _ref.maxRpe = 1e-4;
    _ref.maxRotationDiff = math::degToRad(1.);
...
TEST_F(SQPnPTest, SmallScaleWithNoise)
{
    // Configs
...
TEST_F(SQPnPTest, LargeScaleWithNoise)
{
    // Configs
    _opts.imgNoise = 1. / kFocalLength;
...
TEST_F(SQPnPTest, SmallScaleWithNoise_NoRotation)
{
    // Configs
    _opts.imgNoise = 1. / kFocalLength;
    _ref.maxRpe = 5e-3;
...
TEST_F(SQPnPTest, SmallScaleWithNoise_NoTranslation)
{
    // Configs
    _opts.imgNoise = 1. / kFocalLength;
    _ref.maxRpe = 1e-2;
...
TEST_F(SQPnPTest, SmallScaleWithNoise_OrthogonalRotation)
{
    // Configs
    _opts.imgNoise = 1. / kFocalLength;
    _ref.maxRpe = 5e-3;
