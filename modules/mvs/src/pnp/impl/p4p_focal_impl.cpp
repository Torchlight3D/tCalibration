                                ...
                                std::vector<Eigen::Vector3d>* depths)
{
    ...
    coeffs(19) = a1 * a1 + a2 * a2 - ((a1 * a1) * glac) / glad -
                 ((a2 * a2) * glac) / glad;
    coeffs(20) =
    ...
    // Slightly awkward because of indexing differences from Matlab.
    ...
    const Eigen::Matrix<double, 78, 10> solved_mat =
    ...
    Eigen::EigenSolver<Matrix10d> eigensolver(eigen_mat);
