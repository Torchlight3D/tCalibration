...
public:
                         ...
                         const Control& u)
    {
        ...
        computeCovarianceFromSigmaPoints(x, sigmaStatePoints, s.getCovariance(),
                                         P);
...
protected:
    ...
    bool computeKalmanGain(
        ...
        const Covariance<Measurement>& P_yy, KalmanGain<Measurement>& K) const
    {
        ...
        Matrix<T, State::RowsAtCompileTime, Measurement::RowsAtCompileTime>
            P_xy = (sigmaStatePoints.colwise() - x).cwiseProduct(W).eval() *
