...
{
public:
    //! Optical center is used to calculate Homography
    Quad(const std::array<cv::Point2f, 4>& corners,
    ...
    inline auto interpolate01(float x, float y) const
    {
    ...
    std::array<cv::Point2f, 4> quadPoints;
